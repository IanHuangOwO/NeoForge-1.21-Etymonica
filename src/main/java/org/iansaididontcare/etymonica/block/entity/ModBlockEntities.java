...
public class ModBlockEntities {
        ...
        public static final Supplier<BlockEntityType<EnchantingTableTier2BlockEntity>> ENCHANTING_TABLE_TIER2_BE =
                BLOCK_ENTITIES.register("enchanting_table_tier2_be", () -> new BlockEntityType<>(
                        EnchantingTableTier2BlockEntity::new,
                        ModBlocks.ENCHANTING_TABLE_TIER2.get()));
        ...
        public static final Supplier<BlockEntityType<InfusionAltarTier1BlockEntity>> INFUSION_ALTAR_TIER1_BE =
                BLOCK_ENTITIES.register("infusion_altar_tier1_be", () -> new BlockEntityType<>(
                        InfusionAltarTier1BlockEntity::new,
                        ModBlocks.INFUSION_ALTAR_TIER1.get()));
        
                        public static final Supplier<BlockEntityType<InfusionAltarTier2BlockEntity>> INFUSION_ALTAR_TIER2_BE =
